...
HD_PWD='C:/Users/USER/Desktop/lab_5/test/Table_Tennis/Table_Tennis.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Table_Tennis.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Table_Tennis.tcl -notrace
