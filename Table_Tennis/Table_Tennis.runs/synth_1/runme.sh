...
HD_PWD='C:/Users/USER/Desktop/lab_5/test/Table_Tennis/Table_Tennis.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Table_Tennis.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Table_Tennis.tcl
