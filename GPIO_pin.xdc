...
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS25} [get_ports {i_btn}]
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS25} [get_ports {i_check}]
set_property -dict {PACKAGE_PIN AB10 IOSTANDARD LVCMOS25}  [get_ports {io_gpio}] 
